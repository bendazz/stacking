// iris.js
// Iris dataset: 150 samples, each with 4 features and a class (0, 1, or 2)
...
const IRIS_DATA = [
    ...
    [6.7,3.1,5.6,2.4,2],[6.9,3.1,5.1,2.3,2],[6.8,3.2,5.9,2.3,2],[6.7,3.3,5.7,2.5,2],[6.7,3.0,5.2,2.3,2],
    [6.3,2.5,5.0,1.9,2],[6.5,3.0,5.2,2.0,2],[6.2,3.4,5.4,2.3,2],[5.9,3.0,5.1,1.8,2]
];
